...
function displayCards(card) {
  ...
  p1.innerHTML = `<strong>Rental Location: </strong> ${card.rental_location}`;
  p1.innerHTML = `<strong>Address: </strong> ${card.address}`;
  p2.innerHTML = `<strong>Phone number: </strong> ${card.phone_number}`;
  p3.innerHTML = `<strong>Reservation: </strong> ${card.reservation}`;
  p4.innerHTML = `<strong>Walk-In: </strong> ${card.walk_in}`;
